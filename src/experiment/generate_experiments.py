...
add('--dsdir', help='Directory to look for the processed dataset')
...
conditions = {
    'lstm_factored': [
        {'hidden_size': 128, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 128, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 128, 'layers': 4, 'num_heads': 4},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 4},
        {'hidden_size': 512, 'layers': 4, 'num_heads': 4},
    ],
    'lstm_flat': [
        {'hidden_size': 128, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 8},
    ...
    'transformer_sft': [
        {'hidden_size': 128, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 4, 'num_heads': 8, 'big_mem': True, 'long_train': True},
        {'hidden_size': 128, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 2, 'num_heads': 8, 'long_train': True},
        {'hidden_size': 128, 'layers': 4, 'num_heads': 4},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 4},
        {'hidden_size': 512, 'layers': 4, 'num_heads': 4, 'long_train': True},
    ],
    'transformer_sft_wa': [
        {'hidden_size': 128, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 4, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 4, 'num_heads': 8, 'long_train': True},
        {'hidden_size': 128, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 256, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 512, 'layers': 2, 'num_heads': 8},
        {'hidden_size': 128, 'layers': 4, 'num_heads': 4},
...
# jz version # TODO env variable for src import
run_str = """#!/bin/bash
...
path = op.join(args.expe_path, dt)
